...
public extension XXExtension where Base:UIImageView{
    ...
    public var statusImageMap:[UInt:UIImage?]? {
        get {
            ...
            var list = objc_getAssociatedObject(base, &XX_Ex_ImageView_Status_Image_List_Key) as? [UInt : UIImage?]
        ...
        set {
            objc_setAssociatedObject(base, &XX_Ex_ImageView_Status_Image_List_Key, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }
